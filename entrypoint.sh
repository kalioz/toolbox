...
[ -f ~/.kubectl_aliases.sh ]  && echo " kubectl-aliases (https://github.com/ahmetb/kubectl-aliases )"
[ -f ~/.kube-ps1.plugin.sh ] && echo " ohmyzsh/kube-ps1 (https://github.com/ohmyzsh/ohmyzsh/tree/master/plugins/kube-ps1) [kubeon / kubeoff]"
[ -f ~/.git-prompt.sh ] && echo " git-prompt (https://raw.githubusercontent.com/git/git/master/contrib/completion/git-prompt.sh)"
echo ""
echo "=================================================="
echo ""
/bin/bash